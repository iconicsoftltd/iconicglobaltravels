...
const SalesReturnChalanPrint = (
  selectedSalesReturnData: any[],
  currentCurrency: any
) => {
              ...
              return `
                <div class="p-6  no-break">
                  ...
                  <div class="grid grid-cols-2 text-sm mb-4">
                    <div>
                      <p><span class="font-semibold">Return Invoice No:</span> ${
                        salesReturn.invoiceNo
                      }</p>
                      <p><span class="font-semibold">Customer Name:</span> ${customer}</p>
                      <p><span class="font-semibold">Customer Balance:</span> (${
                        currentCurrency.name
                      }) ${
                salesReturn.customer?.balance?.toFixed(2) || "0.00"
              }</p>
                ...
                salesReturn.account?.balance?.toFixed(2) || "0.00"
              }</p>
                    </div>
                  </div>
                ...
                ${
                  index < selectedSalesReturnData.length - 1
...
export default SalesReturnChalanPrint;